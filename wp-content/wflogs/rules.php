...
$this->rules[723] = wfWAFRule::create($this, 723, NULL, 'priv-esc', '100', 'WAF-RULE-723', 0, 'block', new wfWAFRuleComparisonGroup(new wfWAFRuleComparison($this, 'match', '/\\/wp\\-admin[\\/]+admin\\-ajax\\.php/i', array(wfWAFRuleComparisonSubject::create($this, 'server.script_filename', array (
